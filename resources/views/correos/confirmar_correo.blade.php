...
<html>
  <head>
    <meta charset="utf-8">
    <title>Confirmar correo :: Laravel-base</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Confirmar correo">
  ...
  <body>
    <h2>Saludos</h2>
    Copie y pegue el siguiente enlace en el navegador para confirmar correo:
    <p>
      <code>
        {{ route('perfil.confirmarCorreo', [$usuario_id, $correo, $tipo_operacion_id, $token]) }}
      </code>
    </p>
