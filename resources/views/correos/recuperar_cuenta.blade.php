...
<html>
  <head>
    <meta charset="utf-8">
    <title>Recuperar cuenta :: Laravel-base</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Recuperar cuenta">
  ...
  <body>
    <h2>Saludos</h2>
    Copie y pegue el siguiente enlace en el navegador para recuperar cuenta: 
    <p>
      <code>
        {{ route('perfil.mostrarFrmRecuperarCuenta', [$usuario_id, $correo, $tipo_operacion_id, $token]) }}
      </code>
    </p>
